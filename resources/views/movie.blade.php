            ...
            @foreach ($cast as $role)
                <div class = "row justify-content-center p-3">
                    ...
                    @else
                        ...
                        width = 160 height = 160 class = "img-fluid img-thumbnail p-lg-2 p-md-1 shadow" alt="">
                    @endif
                    <a href = "../actor/{{ $role->imdbID }}" class = "btn-block pt-2 p-0 m-0 text-center">{{ $role->name }}</a>
                    <p class="p-0 d-block w-100 m-0 text-center">plays</p>
                    <p class="p-0 d-block w-100 m-0 text-center">{{ $role->role }}</p>
                </div>
            @endforeach
        </div>
        <div class = "p-5">
